...
var CheckersScraper_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CheckersScraper = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("axios");
const cheerio = require("cheerio");
const fallback_products_1 = require("./fallback-products");
let CheckersScraper = CheckersScraper_1 = class CheckersScraper {
    constructor() {
        this.store = 'checkers';
        this.logger = new common_1.Logger(CheckersScraper_1.name);
    ...
    async search(query) {
        ...
        try {
            ...
            this.logger.warn(`Checkers search failed for "${query}": ${err.message}`);
            return (0, fallback_products_1.buildFallbackProducts)(this.store, query);
        }
    }
    parsePrice(text) {
...
exports.CheckersScraper = CheckersScraper;
exports.CheckersScraper = CheckersScraper = CheckersScraper_1 = __decorate([
    (0, common_1.Injectable)()
], CheckersScraper);
//# sourceMappingURL=checkers.scraper.js.map